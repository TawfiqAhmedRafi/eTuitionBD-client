    ...
    <div className="p-2 md:p-6 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
        {[
          ...
          { title: "Pending Tuitions", value: cards.pendingTuitions },
          { title: "Total Tutors", value: cards.totalTutors },
          { title: "Total Students", value: cards.totalStudents },
          { title: "Total Revenue (BDT)", value: cards.totalRevenue },
        ].map((item, index) => (
          <Card
            key={item.title}
            title={item.title}
