...
const StatCard = ({ value, label }) => (
  <div className="card bg-base-200 shadow-md rounded-2xl p-6 flex items-center text-center transition-all duration-300 border border-base-300/40 hover:-translate-y-1 hover:shadow-xl hover:backdrop-blur-sm hover:bg-base-100/80">
